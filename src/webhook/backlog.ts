...
export async function buildRenderItemsForIssue(
  ...
  const commonVars = {
    ...
    PARTY_A_REP:              draft.PARTY_A_REPRESENTATIVE || "",
    ...
    PARTY_B_NAME:             draft.PARTY_B_NAME || getField("BACKLOG_FIELD_COUNTERPARTY"),
    PARTY_B_ADDRESS:          draft.PARTY_B_ADDRESS || getField("BACKLOG_FIELD_COUNTERPARTY_ADDRESS"),
    PARTY_B_REPRESENTATIVE:   draft.PARTY_B_REPRESENTATIVE || getField("BACKLOG_FIELD_COUNTERPARTY_REP"),
    PARTY_B_REP:              draft.PARTY_B_REP || draft.PARTY_B_REPRESENTATIVE || getField("BACKLOG_FIELD_COUNTERPARTY_REP"),
    VENDOR_NAME:              draft.VENDOR_NAME || draft.PARTY_B_NAME || getField("BACKLOG_FIELD_COUNTERPARTY"),
    VENDOR_ADDRESS:           draft.VENDOR_ADDRESS || draft.PARTY_B_ADDRESS || getField("BACKLOG_FIELD_COUNTERPARTY_ADDRESS"),
    VENDOR_REP:               draft.VENDOR_REP || draft.PARTY_B_REPRESENTATIVE || getField("BACKLOG_FIELD_COUNTERPARTY_REP"),
    ...
    COUNTERPARTY_NAME:        draft.PARTY_B_NAME || getField("BACKLOG_FIELD_COUNTERPARTY"),
    COUNTERPARTY_ADDRESS:     draft.PARTY_B_ADDRESS || getField("BACKLOG_FIELD_COUNTERPARTY_ADDRESS"),
    COUNTERPARTY_REPRESENTATIVE: draft.PARTY_B_REPRESENTATIVE || getField("BACKLOG_FIELD_COUNTERPARTY_REP"),
...
async function loadDocumentDraft(
  ...
  const counterpartyName = input.fallbackCounterparty || vendor?.vendorName || "";
  ...
  return {
    ...
    PARTY_B_NAME: savedDraft.PARTY_B_NAME || counterpartyName,
    PARTY_B_ADDRESS: savedDraft.PARTY_B_ADDRESS || counterpartyAddress || vendor?.address || "",
    PARTY_B_REPRESENTATIVE: savedDraft.PARTY_B_REPRESENTATIVE || counterpartyRep || vendorRepresentative || "",
    PARTY_B_REP: savedDraft.PARTY_B_REP || savedDraft.PARTY_B_REPRESENTATIVE || counterpartyRep || vendorRepresentative || "",
    VENDOR_NAME: savedDraft.VENDOR_NAME || counterpartyName,
    VENDOR_ADDRESS: savedDraft.VENDOR_ADDRESS || counterpartyAddress || vendor?.address || "",
    VENDOR_REP: savedDraft.VENDOR_REP || counterpartyRep || vendorRepresentative || "",
